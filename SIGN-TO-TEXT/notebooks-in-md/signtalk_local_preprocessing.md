...
---
## Cell 5 - Extra Optimized extraction helpers
...
## Cell 9 — Text Augmentation (Gemini API)
...
The current version has been augemented with a multi-threaded approach to speed up the text-generation pipeline
